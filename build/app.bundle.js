...
/******/ 	__webpack_require__.p = "/second_layout/";
/******/
...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"main/__map/_map_images/Pin%20.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

var _mapMarker = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"main/__map/_map_images/map-marker.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
$('.search-box-button').on('click', function () {
	$('#search-box1').css('background-color', 'rgb(231, 87, 53)');
...
var month_left_change = function month_left_change() {
	changed_month -= 1;
	if (changed_month < 0) {
		changed_month = 11;
...
var month_right_change = function month_right_change() {
	changed_month += 1;
	if (changed_month > 11) {
		changed_month = 0;
		console.log(changed_month);
